		...
		<div class="row col-8 mx-auto mt-3">
			...
			<form action="password_reset.php" method="post" accept-charset="utf-8">
				<div class="mb-3">
					...
					<?php endif ?>
					<input type="text" name="name" placeholder="ユーザ名" class="col-12 form-control" value="<?php if(isset($_SESSION["name"])) { echo $_SESSION["name"]; } ?>">
				</div>
				<div class="mb-3">
					<input type="email" name="email" placeholder="メールアドレス" class="col-12 form-control" value="<?php if(isset($_SESSION["email"])) { echo $_SESSION["email"]; } ?>">
				</div>
				<div class="mb-3">
